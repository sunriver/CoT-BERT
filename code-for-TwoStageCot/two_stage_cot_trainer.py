...
class TwoStageCoTTrainer(Trainer):
    """
    两阶段思维链训练器：继承Trainer，实现SentEval评估
    支持两阶段模版的训练和评估
    """
    ...
    def evaluate(
        ...
        # 添加两阶段相关的评估指标
        metrics["eval_twostage_stsb"] = stsb_spearman
        metrics["eval_twostage_sickr"] = sickr_spearman
    ...
    def train(self, model_path: Optional[str] = None, trial: Union["optuna.Trial", Dict[str, Any]] = None):
        ...
        logger.info("***** Running TwoStageCoT Training *****")
        ...
        logger.info("\n\nTwoStageCoT Training completed. Do not forget to share your model on huggingface.co/models =)\n\n")
