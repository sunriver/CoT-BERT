...
{Anonymous \MakeLowercase{\textit{et al.}}: MV-RaCL: Multi-View Role-Aware Contrastive Learning}
...
\begin{figure*}[!htbp]
\centering
\subfloat[Base CoT-BERT]{\includegraphics[width=0.46\linewidth]{his_base_cot}\label{fig:cos-base}}
\hfill
\subfloat[Full model (MV-RaCL)]{\includegraphics[width=0.46\linewidth]{his_full_model}\label{fig:cos-full}}
...
\begin{figure*}[!htbp]
\centering
\subfloat[Readout from <CLS>]{\includegraphics[width=0.46\linewidth]{cls_scatter}\label{fig:scatter-cls}}
\hfill
\subfloat[Readout from the second <MASK> (MASK2)]{\includegraphics[width=0.46\linewidth]{mask_scatter}\label{fig:scatter-mask}}
