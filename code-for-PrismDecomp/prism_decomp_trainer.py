...
class PrismDecompTrainer(Trainer):
    ...
    def train(self, model_path: Optional[str] = None, trial: Union["optuna.Trial", Dict[str, Any]] = None):
        ...
        logger.info("***** Running PrismDecomp Training *****")
        ...
        logger.info(f"  Number of semantic dimensions = {self.model.num_semantics}")
        ...
        logger.info("\n\nPrismDecomp Training completed. Do not forget to share your model on huggingface.co/models =)\n\n")
